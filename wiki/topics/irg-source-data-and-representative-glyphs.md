...
G-source に集中する `IRG N2954` から `IRG N2962` までの proposal / feedback chain は、[G-source Glyph and Source Reference Issues](g-source-glyph-and-reference-issues.md) に分割して追う。V-source / Nom evidence に基づく U+268A1 / U+268A2 と U+2B8A0 の論点は [V-source Representative Glyph Issues](v-source-representative-glyph-issues.md) に分割して追う。
