...
`IRG N2932` は Version 5.0 の chart / list で、各候補の source、attributes、discussion record を含む。`IRG N2933` は Version 5.0 consolidated comments として current catalog に掲載されている。`IRG N2909` の schedule では 2026-08-14 release 予定だったため、Meeting #67 前の comment consolidation として追う。
