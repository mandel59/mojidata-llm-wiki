...
| 2010-05-10 | UTC       | [L2/10-198](../documents/utc-l2-10-198.md)                                             | UTR \#45 Revision 3 draft が、WG2 \#54 後の status changes、DYC characters の扱い、UTC source と IRG evidence の関係を明確化した。                   |
| 2011-11-11 | UTC / IRG | [L2/11-439](../documents/utc-l2-11-439.md) / [IRG N1825R](../documents/utc-l2-11-439.md)                              | Adobe-Japan1-6 由来の 27 ideographs について、`kIRG_USource` の source reference を `UTC-...` から `AJ1-...` へ明確化する提案が出た。                          |
| 2019-05    | IRG / WG2 | [IRG N2369R](../documents/irg-n2369r.md) / [WG2 N5085](../documents/irg-n2369r.md)                                 | UAX \#45 に存在するが U-source identifier を欠く約 150 encoded ideographs に horizontal extension で source identifiers を付ける提案が出た。                  |
| 2020-08/09 | UTC / IRG | [IRG N2439](../documents/irg-n2439.md) / [L2/20-204](../documents/irg-n2439.md)                                   | UTC-02993 と UTC-03009 を Urgently Needed Characters として提出し、現行 UAX \#45 data ではそれぞれ U+9FFF / U+9FFE の encoded records として追跡できる。                 |
...
| 2024-01-11 | UTC       | [L2/24-012](../documents/utc-l2-24-012.md)                                             | UTC \#178 CJK & Unihan Group recommendations が、U-source records の `Variant` 化、U+3150D horizontal extension、UTC-03398 `FutureWS` addition を勧告した。 |
| 2024-04-19 | UTC       | [L2/24-067](../documents/utc-l2-24-067.md)                                             | UTC \#179 CJK & Unihan Working Group recommendations が、UTC-03399 から UTC-03487 までの 89 U-source records を `FutureWS` として受け入れるよう勧告した。 |
...
| source evidence | IRG submission で追跡可能性を示す根拠。UAX \#45 source field は候補整理の入口であり、常に current IRG evidence requirement を満たすとは限らない。 | `IRG N1534`, `IRG N1535`, [L2/10-198](../documents/utc-l2-10-198.md), `L2/25-199` |
...
[L2/08-284](../documents/utc-l2-08-284.md) では、U-source identifier、status field、source field、glyph / data files が定義された。[L2/10-198](../documents/utc-l2-10-198.md) の Revision 3 draft は、同じ 7-field data model を保ちながら、WG2 \#54 後の status changes、DYC characters、UTC source と IRG evidence の関係を明確化した。

2025 年の [L2/25-199](../documents/utc-l2-25-199.md) では、UAX \#45 が Unicode Standard Annex として、`USourceData.txt`、`USourceGlyphs.pdf`、`USourceRSChart.pdf` の 3 data files と、`UTC` / `UCI` / `UK` prefixes、長い status values を説明する形に発展している。
...
この違いは UAX \#45 自体にも残っている。[L2/10-198](../documents/utc-l2-10-198.md) は、UAX \#45 に listed された sources が必ず current IRG evidence requirement を満たすとは限らないと説明し、DYC characters は preliminary exploration であって DYC 全体の符号化根拠として扱わないと注意する。[L2/25-199](../documents/utc-l2-25-199.md) でも同じ注意が current model に引き継がれている。したがって U-source record は「将来符号化される保証」ではなく、UTC が候補・根拠・処理状態を管理する public record と読む必要がある。
...
この intake pressure は 2024 年から見える。[L2/24-067](../documents/utc-l2-24-067.md) は UTC-03399 から UTC-03487 までの 89 records を `FutureWS` とし、[L2/24-165](../documents/utc-l2-24-165.md) は UTC-03488 から UTC-03511 までの 24 records と、244 UAX \#45 ideographs からなる UTC submission for IRG Working Set 2024 を扱った。2026 年の intake pause は、この蓄積を前提に読む必要がある。

2026 年の decision set には、古籍由来の [L2/26-043](../documents/utc-l2-26-043.md)、日本地名の [L2/26-044](../documents/utc-l2-26-044.md)、用途が分散する [L2/26-057](../documents/utc-l2-26-057.md)、略字・簡体字形の [L2/26-064](../documents/utc-l2-26-064.md) / [L2/26-071](../documents/utc-l2-26-071.md) / [L2/26-083](../documents/utc-l2-26-083.md) / [L2/26-085](../documents/utc-l2-26-085.md)、民俗資料・信仰資料に関わる [L2/26-072](../documents/utc-l2-26-072.md)、癸 related character の [L2/26-080](../documents/utc-l2-26-080.md) が含まれる。
...
- [L2/10-198](../documents/utc-l2-10-198.md) - UTR \#45 Revision 3 proposed update。
...
- [L2/26-043](../documents/utc-l2-26-043.md), [L2/26-044](../documents/utc-l2-26-044.md), [L2/26-057](../documents/utc-l2-26-057.md), [L2/26-064](../documents/utc-l2-26-064.md), [L2/26-071](../documents/utc-l2-26-071.md), [L2/26-072](../documents/utc-l2-26-072.md), [L2/26-080](../documents/utc-l2-26-080.md), [L2/26-083](../documents/utc-l2-26-083.md), [L2/26-085](../documents/utc-l2-26-085.md) - UTC \#187 で FutureWS records として受け入れられた 2026 UAX \#45 additions。
