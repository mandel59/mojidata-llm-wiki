...
bodies: [IRG, WG2, SC2]
documents: [utc-l2-21-134, irg-n1081, irg-n1133, irg-n2702, irg-n2733r, irg-n2765, irg-n2799, irg-n2826, irg-n2852, irg-n2878, irg-n2878r, irg-n2878r2, irg-n2878r3, irg-n2890, irg-n2895, irg-n2909, irg-n2917, irg-n2935, wg2-n5354, wg2-n5358, wg2-n5361r]
...
議論は、IDS を実際の字形レベルで簡潔に記述したい要求、教育・辞書・検索で使われる部件リスト、各 member body の component data をどう統合するかから始まった。2004-2005 年には China と TCA から component data / decomposition rules の先行文書が出ており、`IRG N2733R` は China の GF 3001-1997 / GF 0014-2009 を土台に 131 components を提案し、`IRG N2799` は HKSAR、TCA、Vietnam、Jianzi Musical Notation 由来の追加 data を含む CJKV 全体の整理へ拡張した。
...
| 日付・時期 | Body | 文書 | できごと |
| --- | --- | --- | --- |
| 2004-2005 | IRG | [IRG N1081](../documents/irg-n1081.md), [IRG N1133](../documents/irg-n1133.md) | China / TCA から ideographic components の初期提案と basic components / decomposition rules の入力が出ている。現行 proposal の直接の text ではないが、component encoding の先行例として catalog に残る。 |
| 2021-07 | UTC | [L2/21-134](../documents/utc-l2-21-134.md) | IDS 用の ideograph component collection が UTC 側にも提出される。後の [IRG N2733R](../documents/irg-n2733r.md) が参照する前史の一つ。 |
| 2024-10 | IRG | [IRG N2733R](../documents/irg-n2733r.md) | China が GF 3001-1997 / GF 0014-2009 を支える 131 CJK components の preliminary proposal を提出。 |
| 2024-10 | IRG | [IRG N2702](../documents/irg-n2702.md) | IRG \#63 Recommendation M63.17 が、CJK components block の符号化は useful かつ long overdue とし、TCA / HKSAR に追加 data の検討・参加を促す。 |
| 2025-03 | IRG | [IRG N2799](../documents/irg-n2799.md) | China が multi-source の CJKV components proposal へ拡張。HKSAR、TCA、Vietnam、Jianzi Musical Notation、public IDS database 由来の data を加える。 |
| 2025-03 | IRG | [IRG N2765](../documents/irg-n2765.md) | IRG \#64 Recommendation M64.19 が [IRG N2799](../documents/irg-n2799.md) の継続開発を encourage し、TCA の CMEX CJK Components Review Tool を review/comment の場として紹介する。 |
| 2025-05 | IRG | [IRG N2852](../documents/irg-n2852.md) | Night Koo が traditional printing orthography に基づく 4 components の追加を [IRG N2799](../documents/irg-n2799.md) へ提案する。 |
| 2025-10-10 | IRG | `IRG N2878`, [IRG N2890](../documents/irg-n2890.md) | Wang Xieyang が `IRG N2878` への feedback として、5 components の追加と Jianzi Musical Notation components の representative glyph style 修正を提案する。`IRG N2878` は [IRG N2799](../documents/irg-n2799.md) の後続版で、catalog entry `irg-n2878` は [IRG N2878R3](../documents/irg-n2878r3.md) の revision lineage と [IRG N2890](../documents/irg-n2890.md) を provenance とする derived entry である。 |
...
| 2025-10-16 | IRG | [IRG N2826](../documents/irg-n2826.md) | IRG \#65 Recommendation M65.23 が `IRG N2878R` を review し、source references、property data、non-G glyph の finalization を求める。Action Item では authors に final attribute data と final representative glyphs を含む `R2` version の提出を求めた。 |
| 2026-03-02 | IRG | [IRG N2917](../documents/irg-n2917.md) | Henry Chan が `IRG N2878R2` に対して、variant を component として符号化すべきでない点、HCP source reference、radical data などを feedback する。catalog entry `irg-n2878r2` は [IRG N2826](../documents/irg-n2826.md) の Action Item と [IRG N2917](../documents/irg-n2917.md) の feedback target を provenance とする derived entry である。 |
| 2026-03-11 / 2026-03-20 | IRG / WG2 | [IRG N2878R3](../documents/irg-n2878r3.md) / [WG2 N5358](../documents/irg-n2878r3.md) | [IRG N2878R3 CJKV Components final proposal](../events/irg-n2878r3-cjkv-components-final-proposal.md)。 |
| 2026-03-19 | IRG | [IRG N2909](../documents/irg-n2909.md) | [IRG M66.17 CJKV Components forward to WG2](../events/irg-m66-17-cjkv-components-forward-to-wg2.md)。 |
| 2026-06-26 | WG2 | [WG2 N5354](../documents/wg2-n5354.md) | WG2 \#73 M73.06 が Components-A/B を first amendment additions として扱った。 |
| 2026-07-05 | IRG | [IRG N2935](../documents/irg-n2935.md) | Meeting \#67 agenda が WG2 / SC2 acceptance、Unicode 19.0 target、WS2024 から withdraw すべき 11 ideographs を current status として記録する。 |
...
[IRG N1081](../documents/irg-n1081.md) は GB 13000.1 component standard に基づく China source の component proposal、[IRG N1133](../documents/irg-n1133.md) は CNS 11643-2 の TCA source data と decomposition rules の入力である。`IRG N2799` は、GF 3001-1997 / GF 0014-2009、HKSAR の component tables、TCA-CNS 11643-2、Vietnam 提供 data、public IDS database、Jianzi Musical Notation などを暫定 source として整理した。IRG \#64 では、TCA が CMEX CJK Components Review Tool を demo し、IRG experts が comments や new components を追加できる review environment として扱われた。
...
`IRG N2852` は traditional printing orthography を理由に 4 components を追加提案した。`IRG N2890` は 5 components の追加と Jianzi Musical Notation components の glyph style 修正を提案した。[IRG N2895](../documents/irg-n2895.md) は first batch の各 component に 3 use cases を求め、GF 3001 / GF 0014 / GB/T 25741 などからの lost components と source 間 disunification を指摘した。`IRG N2878R3` は individual contributions を review したうえで、関係が rational decomposition / visual decomposition として十分でない、または GB 18030 implementation level 2 の範囲外であるとして、first batch には採用しない整理を置いている。ただし second or subsequent batches への再提出可能性は残している。
...
- [IRG N1081](../documents/irg-n1081.md) - China source の 146 ideographic components proposal
- [IRG N1133](../documents/irg-n1133.md) - TCA / CNS 11643 の basic components data
- [IRG N2733R](../documents/irg-n2733r.md) - China source の preliminary proposal
- [IRG N2702](../documents/irg-n2702.md) - Meeting \#63 recommendations; CJK components encoding の開始判断
- [IRG N2799](../documents/irg-n2799.md) - multi-source CJKV components proposal
- [IRG N2765](../documents/irg-n2765.md) - Meeting \#64 recommendations; CJKV Components 継続開発と review tool
...
- [IRG N2895](../documents/irg-n2895.md) - feedback on `IRG N2878R`
