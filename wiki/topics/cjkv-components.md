...
| 2021-07 | UTC | [L2/21-134](../documents/utc-l2-21-134.md) | IDS 用の ideograph component collection が UTC 側にも提出される。後の `IRG N2733R` が参照する前史の一つ。 |
...
| 2025-03 | IRG | [IRG N2765](../documents/irg-n2765.md) | IRG \#64 Recommendation M64.19 が `IRG N2799` の継続開発を encourage し、TCA の CMEX CJK Components Review Tool を review/comment の場として紹介する。 |
