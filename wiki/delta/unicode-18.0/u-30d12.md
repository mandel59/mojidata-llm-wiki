...
title: "Unicode 18.0 glyph delta: U+30D12 𰴒"
description: "U+30D12 𰴒のUnicode 18.0における字形更新、その根拠と審議経緯を整理する。"
slug: u-30d12
codepoint: "U+30D12"
character: "𰴒"
...
Unicode 18.0 delta chartではExtension GのU+30D12が**Representative glyph update**の対象になっている。Unicode 18.0 delta chartでrepresentative glyphが更新される。符号位置のidentityや統合関係は変わらない。
...
- plain textのcode pointはU+30D12のままであり、文字列の置換を要求する変更ではない。
