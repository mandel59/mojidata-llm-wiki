...
title: "Unicode 18.0 glyph delta: U+31F00 𱼀"
description: "U+31F00 𱼀のUnicode 18.0における字形更新、その根拠と審議経緯を整理する。"
slug: u-31f00
codepoint: "U+31F00"
character: "𱼀"
...
Unicode 18.0 delta chartではExtension HのU+31F00が**U-source horizontal extension**の対象になっている。`kIRG_USource=UTC-00804`とrepresentative glyphを追加する。

## 変更内容

`kIRG_USource=UTC-00804`とrepresentative glyphを追加する。

## Unihan dataの差分

| Property | Unicode 17.0 | Unicode 18.0 beta |
| --- | --- | --- |
| `kIRG_USource` | `—` | `UTC-00804` |
...
- plain textのcode pointはU+31F00のままであり、文字列の置換を要求する変更ではない。
