...
title: "Unicode 18.0 glyph delta: U+2148D 𡒍"
description: "U+2148D 𡒍のUnicode 18.0における字形更新、その根拠と審議経緯を整理する。"
slug: u-2148d
codepoint: "U+2148D"
character: "𡒍"
...
Unicode 18.0 delta chartではExtension BのU+2148Dが**Representative glyph update**の対象になっている。Unicode 18.0 delta chartでrepresentative glyphが更新される。符号位置のidentityや統合関係は変わらない。
...
- plain textのcode pointはU+2148Dのままであり、文字列の置換を要求する変更ではない。
