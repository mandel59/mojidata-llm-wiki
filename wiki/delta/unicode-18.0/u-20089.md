...
title: "Unicode 18.0 glyph delta: U+20089 𠂉"
description: "U+20089 𠂉のUnicode 18.0における字形更新、その根拠と審議経緯を整理する。"
slug: u-20089
codepoint: "U+20089"
character: "𠂉"
...
Unicode 18.0 delta chartではExtension BのU+20089が**U-source horizontal extension**の対象になっている。`kIRG_USource=UTC-00814`とrepresentative glyphを追加する。

## 変更内容

`kIRG_USource=UTC-00814`とrepresentative glyphを追加する。

## Unihan dataの差分

| Property | Unicode 17.0 | Unicode 18.0 beta |
| --- | --- | --- |
| `kIRG_USource` | `—` | `UTC-00814` |
...
- plain textのcode pointはU+20089のままであり、文字列の置換を要求する変更ではない。
