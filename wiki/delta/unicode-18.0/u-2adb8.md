...
title: "Unicode 18.0 glyph delta: U+2ADB8 𪶸"
description: "U+2ADB8 𪶸のUnicode 18.0における字形更新、その根拠と審議経緯を整理する。"
slug: u-2adb8
codepoint: "U+2ADB8"
character: "𪶸"
...
Unicode 18.0 delta chartではExtension CのU+2ADB8が**Representative glyph update**の対象になっている。Unicode 18.0 delta chartでrepresentative glyphが更新される。符号位置のidentityや統合関係は変わらない。
...
- plain textのcode pointはU+2ADB8のままであり、文字列の置換を要求する変更ではない。
