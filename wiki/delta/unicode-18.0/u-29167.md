...
title: "Unicode 18.0 glyph delta: U+29167 𩅧"
description: "U+29167 𩅧のUnicode 18.0における字形更新、その根拠と審議経緯を整理する。"
slug: u-29167
codepoint: "U+29167"
character: "𩅧"
...
Unicode 18.0 delta chartではExtension BのU+29167が**G-source reference and glyph update**の対象になっている。G-sourceを`GKX-1378.20`から`GCESI-00558`へ変更し、参照資料に対応する代表字形へ更新する。

## 変更内容

G-sourceを`GKX-1378.20`から`GCESI-00558`へ変更し、参照資料に対応する代表字形へ更新する。

## Unihan dataの差分

| Property | Unicode 17.0 | Unicode 18.0 beta |
| --- | --- | --- |
| `kIRG_GSource` | `GKX-1378.20` | `GCESI-00558` |
...
- plain textのcode pointはU+29167のままであり、文字列の置換を要求する変更ではない。
