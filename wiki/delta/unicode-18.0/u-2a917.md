...
title: "Unicode 18.0 glyph delta: U+2A917 𪤗"
description: "U+2A917 𪤗のUnicode 18.0における字形更新、その根拠と審議経緯を整理する。"
slug: u-2a917
codepoint: "U+2A917"
character: "𪤗"
...
Unicode 18.0 delta chartではExtension CのU+2A917が**Representative glyph update**の対象になっている。Unicode 18.0 delta chartでrepresentative glyphが更新される。符号位置のidentityや統合関係は変わらない。
...
- plain textのcode pointはU+2A917のままであり、文字列の置換を要求する変更ではない。
