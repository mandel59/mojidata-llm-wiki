...
title: "Unicode 18.0 glyph delta: U+201A2 𠆢"
description: "U+201A2 𠆢のUnicode 18.0における字形更新、その根拠と審議経緯を整理する。"
slug: u-201a2
codepoint: "U+201A2"
character: "𠆢"
...
Unicode 18.0 delta chartではExtension BのU+201A2が**U-source horizontal extension**の対象になっている。`kIRG_USource=UTC-00829`とrepresentative glyphを追加する。

## 変更内容

`kIRG_USource=UTC-00829`とrepresentative glyphを追加する。

## Unihan dataの差分

| Property | Unicode 17.0 | Unicode 18.0 beta |
| --- | --- | --- |
| `kIRG_USource` | `—` | `UTC-00829` |
...
- plain textのcode pointはU+201A2のままであり、文字列の置換を要求する変更ではない。
