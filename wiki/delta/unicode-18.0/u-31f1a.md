...
title: "Unicode 18.0 glyph delta: U+31F1A 𱼚"
description: "U+31F1A 𱼚のUnicode 18.0における字形更新、その根拠と審議経緯を整理する。"
slug: u-31f1a
codepoint: "U+31F1A"
character: "𱼚"
...
Unicode 18.0 delta chartではExtension HのU+31F1Aが**Representative glyph update**の対象になっている。Unicode 18.0 delta chartでrepresentative glyphが更新される。符号位置のidentityや統合関係は変わらない。
...
| --- | --- | --- |
| `kIRG_GSource` | `—` | `GWY-44076` |
| `kIRG_USource` | `—` | `UTC-00733` |
...
- plain textのcode pointはU+31F1Aのままであり、文字列の置換を要求する変更ではない。
