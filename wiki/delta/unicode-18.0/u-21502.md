...
title: "Unicode 18.0 glyph delta: U+21502 𡔂"
description: "U+21502 𡔂のUnicode 18.0における字形更新、その根拠と審議経緯を整理する。"
slug: u-21502
codepoint: "U+21502"
character: "𡔂"
...
Unicode 18.0 delta chartではExtension BのU+21502が**Representative glyph update**の対象になっている。Unicode 18.0 delta chartでrepresentative glyphが更新される。符号位置のidentityや統合関係は変わらない。
...
- plain textのcode pointはU+21502のままであり、文字列の置換を要求する変更ではない。
