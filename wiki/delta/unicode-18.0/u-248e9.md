...
title: "Unicode 18.0 glyph delta: U+248E9 𤣩"
description: "U+248E9 𤣩のUnicode 18.0における字形更新、その根拠と審議経緯を整理する。"
slug: u-248e9
codepoint: "U+248E9"
character: "𤣩"
...
Unicode 18.0 delta chartではExtension BのU+248E9が**U-source horizontal extension**の対象になっている。`kIRG_USource=UTC-00805`とrepresentative glyphを追加する。

## 変更内容

`kIRG_USource=UTC-00805`とrepresentative glyphを追加する。

## Unihan dataの差分

| Property | Unicode 17.0 | Unicode 18.0 beta |
| --- | --- | --- |
| `kIRG_USource` | `—` | `UTC-00805` |
...
- plain textのcode pointはU+248E9のままであり、文字列の置換を要求する変更ではない。
