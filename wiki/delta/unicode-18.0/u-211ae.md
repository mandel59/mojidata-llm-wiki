...
title: "Unicode 18.0 glyph delta: U+211AE 𡆮"
description: "U+211AE 𡆮のUnicode 18.0における字形更新、その根拠と審議経緯を整理する。"
slug: u-211ae
codepoint: "U+211AE"
character: "𡆮"
unicode_version: "18.0"
change_type: "G-source reference correction"
documents: [irg-n2826, utc-l2-26-099]
...
Unicode 18.0 delta chartではExtension BのU+211AEが**G-source reference correction**の対象になっている。G-sourceを`GHZ-10711.06`から`GHZR-10766.06`へ変更し、対応する代表字形を更新する。

## 変更内容

G-sourceを`GHZ-10711.06`から`GHZR-10766.06`へ変更し、対応する代表字形を更新する。

## Unihan dataの差分

| Property | Unicode 17.0 | Unicode 18.0 beta |
| --- | --- | --- |
| `kIRG_GSource` | `GHZ-10711.06` | `GHZR-10766.06` |

表はmojidataが固定しているUnicode 17.0 UnihanとUnicode 18.0 beta Unihanの比較である。値が不変でもchart fontの字形変更は別途存在しうる。

## 経緯

IRG N2826とUnicode 18 alpha feedbackを受け、UTC \#187がnormative source changeを受理した。

## 影響

- plain textのcode pointはU+211AEのままであり、文字列の置換を要求する変更ではない。
