...
| `IRG N2369R`, `IRG N2439`, `L2/25-199`, `IRG N2961R2` / `L2/26-147R2` | U-source horizontal extension、U-source UNC proposal、UAX \#45 Revision 31、改訂版74 CJK Unified Ideographs への `kIRG_USource` values と representative glyphs。 | [UAX \#45 / U-Source Ideographs](../topics/uax45-u-source-ideographs.md), [CJK Horizontal Extensions](../topics/cjk-horizontal-extensions.md) |
