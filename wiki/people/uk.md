...
UK は、IRG に参加する member body / source で、UK-source representative glyphs と source data の確認に関わる。IRG Meeting \#67 では、UK-source representative glyph issues と UK Horizontal Extensions が議題に入っている。

## 標準化での役割

| 文書 | 役割 | 関連 topic |
| --- | --- | --- |
| [IRG N2918](../documents/irg-n2918.md) | UK-source representative glyphs for U+3062B / U+30C68 の update proposal。 | [IRG Source Data and Representative Glyphs](../topics/irg-source-data-and-representative-glyphs.md) |
...
- [IRG N2918](../documents/irg-n2918.md) - UK-source representative glyph issues
