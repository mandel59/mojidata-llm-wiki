...
slug: eiso-chan
bodies: [UTC, IRG]
documents: [irg-n2799, irg-n2878r3, irg-n2926, irg-n2951, utc-l2-23-123, utc-l2-23-127, utc-l2-25-151r]
...
Eiso Chan は、CJKV Components proposal、`kIRG_SGSource`、FS / SC guidelines、ideographic punctuation proposals、Kana proposals / feedback など複数の CJK / ideographic 文書に関わる contributor である。`IRG N2799` では Jianzi Musical Notation などの追加 data source を提供する author として現れ、`IRG N2878R3` の final proposal author list にも含まれる。Kana 関連では、Ryukyuan superscript Katakana proposal への feedback、明治期 alternate Katakana NE / WI の introduction、後続の revised proposal に関係している。
...
| `L2/23-127` | 明治期活字見本に現れる alternate Katakana NE / WI の introduction。 | [Kana](../topics/kana.md) |
| `L2/25-151R` | KATAKANA LETTER ALTERNATE NE / WI revised proposal。 | [Kana](../topics/kana.md), [CJK Security Confusables](../topics/cjk-security-confusables.md) |
